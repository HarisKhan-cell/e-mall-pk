...
### Step 3: Update `app/admin/add-product/page.tsx`

Open `app/admin/add-product/page.tsx` in VS Code, replace everything in it with this code:
...
export default function AdminMasterPortal() {
  ...
  const handleResetToDefault50 = () => {
    if (confirm('Are you sure you want to reset back to the default catalog?')) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-3 bg-amber-950/40 border border-amber-500/30 p-6 rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                ...
                <p className="text-gray-300 text-xs mt-0.5">Export active catalog data or reset back to default 50 items anytime.</p>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-5 py-3 bg-white/10 hover:bg-white/20 text-white font-extrabold text-xs rounded-2xl border border-white/10 flex items-center gap-2 uppercase tracking-wider transition-all whitespace-nowrap"
                >
