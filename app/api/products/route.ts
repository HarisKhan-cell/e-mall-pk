...
export async function GET() {
  const products = [
    // --- KHAADI PRODUCTS ---
    {
      ...
      description: 'Multi-colored cotton dobby embroidered kurta with V-neckline.',
      price: 3990,
      stock: 15,
    ...
    {
      id: 'sapphire-1',
      title: 'Sapphire Ready to Wear Printed Shirt',
      description: 'Stitched daily wear digital printed lawn shirt (PRW26SSTV961).',
      price: 3490,
      stock: 18,
      category: { name: 'Fashion & Apparel' },
    ...
    },
    {
      ...
      description: '3-Piece stitched luxury cotton lawn suit with chiffon dupatta.',
      price: 7490,
      stock: 6,
      category: { name: 'Fashion & Apparel' },
      shop: { name: 'Sapphire Official', commissionRate: 5.0 },
    ...
    {
      id: 'ethnic-1',
      title: 'Ethnic Strappy Flat Sandal (Beige)',
      description: 'Chic hand-crafted flat sandal with cushioned sole (E1203-109).',
      price: 3490,
      stock: 10,
    ...
    },
    {
      ...
      description: 'Traditional embellished flat sandal for festive & casual wear (E1103-109).',
      price: 3990,
      stock: 12,
      category: { name: 'Shoes & Footwear' },
      shop: { name: 'ETHNIC Official', commissionRate: 5.0 },
    ...
    },
    {
      ...
      description: 'Sleek everyday slip-on flat sandal (E1084-109).',
      price: 2990,
      stock: 15,
      category: { name: 'Shoes & Footwear' },
      shop: { name: 'ETHNIC Official', commissionRate: 5.0 },
    ...
    },
    {
      ...
      description: 'Soft padded strap casual sandal (E1101-109).',
      price: 3290,
      stock: 11,
      category: { name: 'Shoes & Footwear' },
      shop: { name: 'ETHNIC Official', commissionRate: 5.0 },
